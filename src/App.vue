  ...
  <div class="font-Muffin text-black">
      ...
      <div>
        ...
        <div class="absolute top-[70%] left-1/2 transform -translate-x-1/2 -translate-y-1/2">
          ...
          <div class="flex items-center gap-4">
            <button @click="prevCharacter" class="px-4 py-2 bg-gray-200 hover:bg-gray-300 rounded-full shadow-md transition text-5xl transform hover:scale-125">
              < 
            </button>
            ...
            <button @click="nextCharacter" class="px-4 py-2 bg-gray-200 hover:bg-gray-300 rounded-full shadow-md transition text-5xl transform hover:scale-125">
              >
            </button>
          </div>
        </div>
    ...
    <div v-show="currentView === 'game'"
      ...
      >
        ...
        <div
          class="grid grid-cols-3 gap-2 gap-y-10 sm:gap-2 md:gap-2 lg:gap-2 mt-32 sm:mt-28 md:mt-28 lg:mt-16 xl:mt-30">
